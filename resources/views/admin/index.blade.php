                                ...
                                <li class="list-group-item todo-item" data-role="task">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label w-100 mb-0 todo-label" for="customCheck">
                                            <span class="todo-desc fw-normal">Lorem Ipsum is simply dummy
                                ...
                                <li class="list-group-item todo-item" data-role="task">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label w-100 mb-0 todo-label" for="customCheck1">
                                            <span class="todo-desc fw-normal">Lorem Ipsum is simply dummy
                                                text of the printing</span><span
                        ...
                        <li class="d-flex no-block card-body">
                            ...
                            <div>
                                <a href="#" class="mb-0 font-medium p-0">Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit.</a>
                                <span class="text-muted">dolor sit amet, consectetur
                                    adipiscing</span>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card mt-4">
                        ...
                        <div id="Toggle-1" class="collapse show multi-collapse">
                            <div class="card-body widget-content">
                                ...
                                full of waffle to pad out the comment. Usually,
                                you just wish these sorts of comments would come
                                to an end.
                            </div>
                        </div>
                        ...
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="p-20">
                                <p>
                                    ...
                                    paragraphs and is full of waffle to pad out
                                    the comment. Usually, you just wish these
                                    sorts of comments would come to an
                                    end.multiple paragraphs and is full of
