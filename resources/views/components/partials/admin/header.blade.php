         ...
         <div class="navbar-header" data-logobg="skin5">
             ...
             <a class="navbar-brand" href="index.html">
                 ...
                 <b class="logo-icon ps-2">
                     ...
                     <!-- Dark Logo icon -->
                     <img src="{{ asset('ui/admin/assets/images/logo4.png') }}" alt="homepage" class="light-logo"
                         width="25" />
                 </b>
                 <!--End Logo icon -->
                 <!-- Logo text -->
                 <span class="logo-text ms-2">
                     <!-- dark Logo text -->
                     <img src="{{ asset('ui/admin/assets/images/logo-text2.png') }}" alt="homepage"
                         class="light-logo" />
                 </span>
                 <!-- Logo icon -->
                 <!-- <b class="logo-icon"> -->
             ...
             <ul class="navbar-nav float-start me-auto">
                 ...
                 <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                         ...
                         <span class="d-none d-md-block">Add now
             ...
             <ul class="navbar-nav float-end">
                 ...
                 <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#"
                         ...
                         <img src="{{ asset('ui/admin/assets/images/users/ap1.png') }}" alt="user"
