...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('ui/admin/assets/images/favicon.png') }}" />
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('ui/admin/assets/images/logo-icon.png') }}" alt="homepage"
                        ...
                        <span class="logo-text ms-2">
                            <!-- dark Logo text -->
                            <img src="{{ asset('ui/admin/assets/images/logo-text.png') }}" alt="homepage"
                                class="light-logo" />
                        </span>
                        <!-- Logo icon -->
                        <!-- <b class="logo-icon"> -->
                    ...
                    <a class="nav-toggler waves-effect waves-light d-block d-md-none"
                        href="{{ asset('ui/admin/javascript:void(0)') }}"><i class="ti-menu ti-close"></i></a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-start me-auto">
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link sidebartoggler waves-effect waves-light"
                                href="{{ asset('ui/admin/javascript:void(0)') }}" data-sidebartype="mini-sidebar"><i
                        ...
                        <li class="nav-item search-box">
                            <a class="nav-link waves-effect waves-dark"
                                href="{{ asset('ui/admin/javascript:void(0)') }}"><i
                    ...
                    <ul class="navbar-nav float-end">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end mailbox animated bounceInDown"
                                ...
                                <ul class="list-style-none">
                                    <li>
                                        <div class="">
                                            <!-- Message -->
                                            <a href="{{ asset('ui/admin/javascript:void(0)') }}"
                                                ...
                                                <div class="d-flex no-block align-items-center p-10">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <span class="mail-desc">Just a reminder
                                                            that event</span>
                                                    </div>
                                                </div>
                                            </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic"
                                ...
                                aria-expanded="false">
                                <img src="{{ asset('ui/admin/assets/images/users/1.jpg') }}" alt="user"
                                    class="rounded-circle" width="31" />
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated"
                                aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ asset('ui/admin/javascript:void(0)') }}"><i
                                        class="mdi mdi-account me-1 ms-1"></i>
                                    My Profile</a>
                                <a class="dropdown-item" href="{{ asset('ui/admin/javascript:void(0)') }}"><i
                                        class="mdi mdi-wallet me-1 ms-1"></i>
                                    My Balance</a>
                                <a class="dropdown-item" href="{{ asset('ui/admin/javascript:void(0)') }}"><i
                                        class="mdi mdi-email me-1 ms-1"></i>
                                    Inbox</a>
                    ...
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="{{ asset('ui/admin/javascript:void(0)') }}" aria-expanded="false"><i
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="{{ asset('ui/admin/javascript:void(0)') }}" aria-expanded="false"><i
                                    class="mdi mdi-face"></i><span class="hide-menu">Icons
                                </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                All Rights Reserved by Matrix-admin. Designed and Developed
                by
